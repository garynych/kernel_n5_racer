...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_RACER_PS)
extern struct cpufreq_governor cpufreq_gov_racerps;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_racerps)
